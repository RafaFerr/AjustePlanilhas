...
import logging
logging.basicConfig(level=logging.INFO, filename="C:\RPA\PlanilhaExcel\AjustarPlanilha\AjustarPlanilha\logs\log_qualificacao_ancelmo.txt", format="%(asctime)s $ %(message)s",datefmt='%d/%m/%Y %I:%M:%S %p')
